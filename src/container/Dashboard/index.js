...
class DashBoard extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    console.log('prev', prevProps.movies)
    console.log('asd', this.props.movies)
  }
  ...
  render() {
    ...
    const { displayString, isLoading } = this.state;
    const loadingSpinner = <div className="d-flex m-auto spinner-border" role="status">
    ...
    return (
      <div>
        ...
        <input type="text" placeholder="Enter Seconds" onChange={e => this.handleInput(e)} />
        <p>{displayString}</p>
      </div>
    );
  }
